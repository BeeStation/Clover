...
readonly BASE_PULL_URL="https://api.github.com/repos/goonstation/goonstation/pulls"
...
if ! git remote | grep goonstation > /dev/null; then
   git remote add goonstation https://github.com/goonstation/goonstation.git
fi
