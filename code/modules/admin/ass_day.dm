...
/*
	...
	src.Browse({"<center><h2>!!! ASS JAM !!!</h2></center><hr>
				...
				Would you like to contribute? Easy Peasy! <a href="[config.github_repo_url]">[config.github_repo_url]</a>! Warcrimes will surely write a guide to joining the Ass Jam, and totally won't forget to do this before april 13th. <br>
